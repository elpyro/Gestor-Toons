...
public class Modelo_usuario {
    private String id, nombre, documento, perfil, correo, telefono, direccion, url_foto_usuario, url_documento1,  url_documento2, maximo_inventario,fecha_ultima_modificacion,usuario_ultima_modificacion, tipo;

    public Modelo_usuario() {
    }

    public Modelo_usuario(String id, String nombre, String documento, String perfil, String correo, String telefono, String direccion, String url_foto_usuario, String url_documento1, String url_documento2, String maximo_inventario, String fecha_ultima_modificacion, String usuario_ultima_modificacion, String tipo) {
        this.id = id;
        this.nombre = nombre;
