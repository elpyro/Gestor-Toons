...
final class PDFUtility_recaudado
{
    ...
    void createPdf(@NonNull Context mContext, OnDocumentClose mCallback, ArrayList<Modelo_registro_recaudados> items, String total_costos, String total_ventas, String total_ganancias, @NonNull String filePath, boolean isPortrait) throws Exception
    {
        if(filePath.equals(""))
        {
        ...
        Paragraph temp = new Paragraph("Total Recaudado: "+formatoImporte.format(total_inventario), FONT_TITLE);
...
//
...

            {
                ...
                Paragraph temp = new Paragraph(mContext.getString(R.string.Recaudado), FONT_TITLE);
                temp.setAlignment(Element.ALIGN_CENTER);
                cell.addElement(temp);
    ...
    public PdfPTable createDataTable(Context mContext, ArrayList<Modelo_registro_recaudados> dataTable) throws DocumentException
    {
