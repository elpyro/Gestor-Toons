...
final class PDFUtility_ganancias
{
    ...
    static void createPdf(@NonNull Context mContext, OnDocumentClose mCallback, ArrayList<Modelo_reporte_ganancias_lista_pdf> items, String total_costos, String total_ventas, String total_ganancias, @NonNull String filePath, boolean isPortrait) throws Exception
    {
        if(filePath.equals(""))
        {
...
//
...

            {
                ...
                Paragraph temp = new Paragraph(mContext.getString(R.string.Reporte_de_ganancias), FONT_TITLE);
            ...
            cell = new PdfPCell(new Phrase( mContext.getResources().getString(R.string.Costos), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(PdfPCell.NO_BORDER);
            total_tabla.addCell(cell);

            cell = new PdfPCell(new Phrase(formatoImporte.format(Integer.parseInt(total_costos))+"", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(PdfPCell.NO_BORDER);
            total_tabla.addCell(cell);

            cell = new PdfPCell(new Phrase( mContext.getResources().getString(R.string.Ventas), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(PdfPCell.NO_BORDER);
            total_tabla.addCell(cell);

            cell = new PdfPCell(new Phrase(formatoImporte.format(Integer.parseInt(total_ventas))+"", FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(PdfPCell.NO_BORDER);
            total_tabla.addCell(cell);

            cell = new PdfPCell(new Phrase( mContext.getResources().getString(R.string.Ganancia), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_RIGHT);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setBorder(PdfPCell.NO_BORDER);
            total_tabla.addCell(cell);
    ...
    private static PdfPTable createDataTable(Context mContext,ArrayList<Modelo_reporte_ganancias_lista_pdf> dataTable) throws DocumentException
    {
        //ELEMENTOS A LAS TABLAS
        PdfPTable table1 = new PdfPTable(7);
        table1.setWidthPercentage(100);
        table1.setWidths(new float[]{0.7f,0.5f,1.5f,0.4f,0.6F,0.6F,1F});
         ...
         PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase(mContext.getResources().getString(R.string.Venta_), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(1f);
            table1.addCell(cell);
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            cell = new PdfPCell(new Phrase(dataTable.get(i).getRef().substring(0,5), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPaddingLeft(left_right_Padding);
            cell.setPaddingRight(left_right_Padding);
            ...
            cell.setBackgroundColor(cell_color);
            table1.addCell(cell);
            cell = new PdfPCell(new Phrase(formatoImporte.format(Integer.parseInt(dataTable.get(i).getPrecio_venta())), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPaddingLeft(left_right_Padding);
            cell.setPaddingRight(left_right_Padding);
            ...
            cell.setBackgroundColor(cell_color);
            table1.addCell(cell);
            cell = new PdfPCell(new Phrase(formatoImporte.format(Integer.parseInt(dataTable.get(i).getGanancia())), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPaddingLeft(left_right_Padding);
            cell.setPaddingRight(left_right_Padding);
            ...
            total_vendedor= total_vendedor+Integer.parseInt(dataTable.get(i).getGanancia());
