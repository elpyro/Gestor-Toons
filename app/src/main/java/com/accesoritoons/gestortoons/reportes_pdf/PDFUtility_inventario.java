...
final class PDFUtility_inventario
{
    ...
    void createPdf(@NonNull Context mContext, OnDocumentClose mCallback, ArrayList<Modelo_registro_inventario_productos> items, String total_costos, String total_ventas, String total_ganancias, @NonNull String filePath, boolean isPortrait) throws Exception
    {
        if(filePath.equals(""))
        {
        ...
        Paragraph temp = new Paragraph("Total Inventario: "+formatoImporte.format(total_inventario), FONT_TITLE);
...
//
...

            {
                ...
                Paragraph temp = new Paragraph(mContext.getString(R.string.Invetario), FONT_TITLE);
                temp.setAlignment(Element.ALIGN_CENTER);
                cell.addElement(temp);
...
//
//            cell = new PdfPCell(new Phrase(total_costos+"", FONT_COLUMN));
//            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
//            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
//            cell.setBorder(PdfPCell.NO_BORDER);
//            total_tabla.addCell(cell);
...
//            total_tabla.addCell(cell);
//
//            cell = new PdfPCell(new Phrase(total_ventas+"", FONT_COLUMN));
//            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
//            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
//            cell.setBorder(PdfPCell.NO_BORDER);
//            total_tabla.addCell(cell);
...
//            total_tabla.addCell(cell);
//
//            cell = new PdfPCell(new Phrase(total+"", FONT_TITLE));
//            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
//            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
//            cell.setBorder(PdfPCell.NO_BORDER);
//            total_tabla.addCell(cell);
...
//            document.add(total_tabla);
    ...
    public PdfPTable createDataTable(Context mContext, ArrayList<Modelo_registro_inventario_productos> dataTable) throws DocumentException
    {
        ...
        table1.setWidths(new float[]{1.5f,0.4f,0.6F,1F});
        ...
        PdfPCell celda_cliente;
        {
            ...
            celda_cliente = new PdfPCell(new Phrase(dataTable.get(ultimo_elemento).getNombre_vendedor()+"\n"+ dataTable.get(ultimo_elemento).getTipo_vendedor(), FONT_COLUMN));
            celda_cliente.setHorizontalAlignment(Element.ALIGN_CENTER);
            celda_cliente.setVerticalAlignment(Element.ALIGN_MIDDLE);
            celda_cliente.setBackgroundColor(BaseColor.YELLOW);
            celda_cliente.setPadding(10f);
