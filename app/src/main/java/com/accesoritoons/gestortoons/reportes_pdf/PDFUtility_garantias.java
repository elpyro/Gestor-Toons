...
import com.accesoritoons.gestortoons.modelos.Modelo_graficos;
...
final class PDFUtility_garantias
{
    ...
    public static ArrayList<Modelo_graficos>graficos=new ArrayList<>();
    ...
    void createPdf(@NonNull Context mContext, OnDocumentClose mCallback, ArrayList<Modelo_registro_garantias> items, String total_costos, String total_ventas, String total_ganancias, @NonNull String filePath, boolean isPortrait) throws Exception
    {
        if(filePath.equals(""))
        {
...
//
...

            {
                ...
                Paragraph temp = new Paragraph(mContext.getString(R.string.Garantias), FONT_TITLE);
                ...
                String fecha_desde="";
                String fecha_hasta="";
                if (!Activity_vista_pdf.desde.equals("1980-01-01")) {
                    fecha_desde= mContext.getResources().getString(R.string.Desde)+": "+ Activity_vista_pdf.desde ;
                }else{
                    fecha_desde="";
                }
                if(!Activity_vista_pdf.hasta.equals("3000-01-01")){
                    fecha_hasta=" "+mContext.getResources().getString(R.string.Hasta) + ": "+ Activity_vista_pdf.hasta;
                }

                temp = new Paragraph(fecha_desde+fecha_hasta ,FONT_SUBTITLE);
                temp.setAlignment(Element.ALIGN_CENTER);
                cell.addElement(temp);
    ...
    public PdfPTable createDataTable(Context mContext, ArrayList<Modelo_registro_garantias> dataTable) throws DocumentException
    {
        graficos.clear();
        ...
        table1.setWidths(new float[]{0.6f,0.4f,1.5F,0.8F,0.8F,0.6F});
         ...
         PdfPCell cell;
        {
            ...
            cell = new PdfPCell(new Phrase(mContext.getResources().getString(R.string.Fecha_recaudo), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(3f);
            table1.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase(mContext.getResources().getString(R.string.Vendedor), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(0.5f);
            table1.addCell(cell);

            cell = new PdfPCell(new Phrase(mContext.getResources().getString(R.string.Recaudado), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(0.5f);
            table1.addCell(cell);
            ...
            cell = new PdfPCell(new Phrase(mContext.getResources().getString(R.string.Costo), FONT_COLUMN));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPadding(0.5f);
            table1.addCell(cell);
        ...
        String cliente_diferente=dataTable.get(0).getId_administrador_recaudo();
        ...
        for (int i = 0; i < size; i++)
        {
            ...
            //total de cliente
            if(!cliente_diferente.equals(dataTable.get(i).getId_administrador_recaudo())){
                ...
                PdfPCell celda_cliente;
                {
                    ...
                    if(dataTable.get(i-1).getReacudado_por().equals("Pendiente")){
                        celda_cliente = new PdfPCell(new Phrase(dataTable.get(i-1).getReacudado_por(), FONT_COLUMN));
                    }else{
                        celda_cliente = new PdfPCell(new Phrase("Recaudados", FONT_COLUMN));
                    }
                    ...
                    celda_cliente.setBorder(PdfPCell.NO_BORDER);
                    table1.addCell(celda_cliente);
                    //graficos.add(new Modelo_graficos(i,total_vendedor,dataTable.get(i-1).getReacudado_por()));
                    total_vendedor=0;

                }
                cliente_diferente=dataTable.get(i).getId_administrador_recaudo();
            }
            ...
            cell = new PdfPCell(new Phrase(dataTable.get(i).getNombre_vendedor(), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPaddingLeft(left_right_Padding);
            cell.setPaddingRight(left_right_Padding);
            ...
            cell = new PdfPCell(new Phrase(dataTable.get(i).getReacudado_por(), FONT_CELL));
            cell.setHorizontalAlignment(Element.ALIGN_CENTER);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            cell.setPaddingLeft(left_right_Padding);
            cell.setPaddingRight(left_right_Padding);
...
//            graficos.add(new Modelo_graficos(i,Integer.parseInt(dataTable.get(i).getCosto()),dataTable.get(i).getNombre()));
            total_vendedor= total_vendedor+Integer.parseInt(dataTable.get(i).getCosto());
            total_inventario=total_inventario+Integer.parseInt(dataTable.get(i).getCosto());
            alternate = !alternate;
        ...
        PdfPCell celda_cliente;
        {
            ...
            if(dataTable.get(ultimo_elemento).getReacudado_por().equals("Pendiente")){
                celda_cliente = new PdfPCell(new Phrase(dataTable.get(ultimo_elemento).getReacudado_por(), FONT_COLUMN));
            }else{
                celda_cliente = new PdfPCell(new Phrase("Recaudados", FONT_COLUMN));
            }
            celda_cliente.setHorizontalAlignment(Element.ALIGN_CENTER);
           ...
           // graficos.add(new Modelo_graficos(ultimo_elemento-1,total_vendedor,dataTable.get(ultimo_elemento-1).getReacudado_por()));
