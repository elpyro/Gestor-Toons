...
final class PDFUtility_pedidos_enviados
{
    ...
    void createPdf(@NonNull Context mContext, OnDocumentClose mCallback, ArrayList<Modelo_registro_pedidos_enviados> items, String total_costos, String total_ventas, String total_ganancias, @NonNull String filePath, boolean isPortrait) throws Exception
    {
        if(filePath.equals(""))
        {
        ...
        Paragraph temp = new Paragraph("Total pedidos: "+formatoImporte.format(total_inventario), FONT_TITLE);
...
//
...

            {
                ...
                Paragraph temp = new Paragraph(mContext.getString(R.string.Pedidos), FONT_TITLE);
                temp.setAlignment(Element.ALIGN_CENTER);
                cell.addElement(temp);
...
//                cell.addElement(temp);
    ...
    public PdfPTable createDataTable(Context mContext, ArrayList<Modelo_registro_pedidos_enviados> dataTable) throws DocumentException
    {
        ...
        table1.setWidths(new float[]{0.6f,1.5F,0.4F,0.4F,1F});
