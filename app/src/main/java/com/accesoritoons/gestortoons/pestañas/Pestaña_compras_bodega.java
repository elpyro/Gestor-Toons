...
public class Pestaña_compras_bodega extends FragmentStateAdapter {

    public Pestaña_compras_bodega(@NonNull FragmentManager fragmentManager, @NonNull Lifecycle lifecycle) {
